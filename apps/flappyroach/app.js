...
// Clear everything from memory that's not needed for Flappy Roach
function clearMemory() {
  ...
  rd = undefined;
  settings = settings || {};
  settings.idleTimeout = 0; // Disable idle timeout for Flappy Roach
  sm0 = undefined;
  tm0 = undefined;
  ts0 = undefined;
...
log('Starting Flappy Roach loader...');
...
log('[Flappy Roach] Loading game...');
eval(fs.readFile('USER/FLAPPYROACH/flappyroach.js'));
