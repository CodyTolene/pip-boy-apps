function ThemePicker() {
  ...
  function draw() {
    ...
    g.drawString(
      'Move the tuner up to toggle 1 or 2 colours',
      SCREEN_WIDTH / 2,
      SCREEN_HEIGHT / 2 - 90,
    );
    if (gradient) {
      ...
      switch (selected) {
        case 0:
          g.drawString(
            'R*:' + theme0[0] + 'G:' + theme0[1] + 'B:' + theme0[2],
            SCREEN_WIDTH / 2,
            SCREEN_HEIGHT / 2 - 50,
          );
          break;
    ...
    g.drawString(
      'Press left wheel in to save and reboot',
      SCREEN_WIDTH / 2,
      SCREEN_HEIGHT / 2 + 90,
    );
    g.drawString(
      'Press torch to reset theme and reboot',
      SCREEN_WIDTH / 2,
      SCREEN_HEIGHT / 2 + 110,
    );
  }
    ...
    if (gradient) {
      for (var i = 0; i < 16; i++) {
        ...
        g.setColor(
          ...
          (((theme1[1] - theme0[1]) * frac + theme0[1]) * i) / 16,
          (((theme1[2] - theme0[2]) * frac + theme0[2]) * i) / 16,
        );
        g.fillRect(
          SCREEN_WIDTH / 2 - offset,
          SCREEN_HEIGHT / 2 - 20,
          SCREEN_WIDTH / 2 - offset + 16,
          SCREEN_HEIGHT / 2 - 4,
        );
        frac = 0.33;
        g.setColor(
      ...
      for (var i = 0; i < 16; i++) {
        ...
        g.setColor(
          (theme0[0] * i) / 16 - (i * 0.2) / 16,
          (theme0[1] * i) / 16 - (i * 0.2) / 16,
          (theme0[2] * i) / 16 - (i * 0.2) / 16,
        );
        g.fillRect(
          SCREEN_WIDTH / 2 - offset,
          SCREEN_HEIGHT / 2 + -4,
        ...
        g.setColor(
          (theme0[0] * i) / 16 - (i * 0.4) / 16,
          (theme0[1] * i) / 16 - (i * 0.4) / 16,
          (theme0[2] * i) / 16 - (i * 0.4) / 16,
        );
        g.fillRect(
          SCREEN_WIDTH / 2 - offset,
          SCREEN_HEIGHT / 2 + 28,
