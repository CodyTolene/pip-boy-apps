// Clear everything from memory that's not needed for Piptris
function clearMemory() {
  ...
  rd = undefined;
  settings = settings || {};
  settings.idleTimeout = 0; // Disable idle timeout for Piptris
  sm0 = undefined;
  tm0 = undefined;
  ts0 = undefined;
...
log('Loading Piptris...');
eval(fs.readFile('USER/PIPTRIS/piptris.min.js'));
